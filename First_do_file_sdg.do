...
import delimited "C:\Users\Ibrahimi_Klea\Desktop\SDG\SDGData.csv", varnames(1) encoding(UTF-8) 
...
keep if indicator==2 | indicator==15 | indicator==44 | indicator==45 |indicator==58 | indicator==133 | indicator==161 | indicator==176 | indicator==177 | indicator==178 | indicator==179 | indicator==211 | indicator== 285| indicator== 286| indicator== 287| indicator==289 | indicator==299 | indicator== 315| indicator== 326 | indicator== 349 | indicator== 374
